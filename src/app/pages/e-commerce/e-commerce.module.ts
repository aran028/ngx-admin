...
import { LineaComponent } from "./consentimiento-transacciones/linea/linea.component";
import { ConsTransHeaderComponent } from "./consentimiento-transacciones/cons-trans-header/cons-trans-header/cons-trans-header.component";
import { PolarComponent } from "./consentimiento-transacciones/polar/polar/polar.component";
import { PieComponent } from "./consentimiento-transacciones/pie/pie/pie.component";
import { BarraComponent } from "./consentimiento-transacciones/barra/barra.component";
@NgModule({
  imports: [
    ThemeModule,
    NbCardModule,
